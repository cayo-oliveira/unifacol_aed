...
\bigskip
% origem: AED-C09-O09
\ItemHeader{1}{Objetiva}{alucinação}{Situação profissional e suporte quantitativo}
...
% origem: AED-C05-O07
\ItemHeader{2}{Objetiva}{Aplicar linhagem e impacto}{Mudança de regra}
...
% origem: AED-C14-D15
\ItemHeader{3}{Discursiva}{Responder a contestação e corrigir o sistema}{Decisão baseada em número errado}
\TextoBase
...
% origem: AED-C03-D15
\ItemHeader{4}{Discursiva}{Escolher distribuição}{Planejamento operacional}
...
% origem: AED-C08-O05
\ItemHeader{6}{Objetiva}{visual}{Situação profissional e suporte quantitativo}
...
% origem: AED-C12-O05
\ItemHeader{7}{Objetiva}{Gerenciar estado e reexecução}{Duplo envio no Streamlit}
\TextoBase
...
% origem: AED-C13-O05
\ItemHeader{8}{Objetiva}{Escolher memória apropriada}{Correção de preferência e regra}
\TextoBase
