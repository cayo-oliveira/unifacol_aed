...
\bigskip
% origem: AED-C09-O03
\ItemHeader{1}{Objetiva}{validação}{Situação profissional e suporte quantitativo}
...
% origem: AED-C10-D13
\ItemHeader{2}{Discursiva}{Integrar evidências e justificar decisão}{Caso profissional do capítulo}
...
% origem: AED-C14-O05
\ItemHeader{3}{Objetiva}{Distinguir alucinação de desatualização}{Política revogada}
\TextoBase
...
% origem: AED-C11-D13
\ItemHeader{4}{Discursiva}{Desenhar arquitetura híbrida}{BI corporativo e Streamlit}
\TextoBase
...
% origem: AED-C13-O01
\ItemHeader{8}{Objetiva}{Distinguir responsabilidades agentic}{Relatório mensal recorrente}
\TextoBase
