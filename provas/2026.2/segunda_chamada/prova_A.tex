...
\bigskip
% origem: AED-C11-D11
\ItemHeader{1}{Discursiva}{Projetar matriz de comparação governada}{Seleção institucional}
\TextoBase
...
% origem: AED-C13-O09
\ItemHeader{4}{Objetiva}{Aplicar recusa segura}{Pergunta sem evidência autorizada}
\TextoBase
...
% origem: AED-C02-O07
\ItemHeader{6}{Objetiva}{Distinguir variância populacional e amostral}{Equipamentos}
...
% origem: AED-C03-O03
\ItemHeader{7}{Objetiva}{Calcular união sem dupla contagem}{Eventos em um dado}
...
% origem: AED-C11-O01
\ItemHeader{8}{Objetiva}{Selecionar ferramenta pela fronteira de governança}{Consulta executiva multifuente}
\TextoBase
