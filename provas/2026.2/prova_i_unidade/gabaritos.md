...
|---|---:|:---:|---:|:---:|---|
| AED-C08-O09 | 1 | A | 5 | A | A→A, D→B, E→C, C→D, B→E |
| AED-C03-O05 | 2 | C | 4 | C | E→A, A→B, C→C, B→D, D→E |
| AED-C05-O03 | 3 | B | 1 | E | A→A, D→B, C→C, E→D, B→E |
| AED-C04-O03 | 4 | B | 8 | E | A→A, E→B, C→C, D→D, B→E |
| AED-C07-D13 | 5 | — | 7 | — | — |
| AED-C01-O09 | 6 | B | 6 | A | B→A, C→B, A→C, D→D, E→E |
| AED-C02-D13 | 7 | — | 3 | — | — |
| AED-C06-O09 | 8 | A | 2 | B | D→A, A→B, B→C, E→D, C→E |

### Critérios originais das discursivas

- **AED-C07-D13:** | AED-C07-D13 | Padrão criterial | Cumprir cada produto solicitado: Proponha análise ética para células pequenas, finalidade, acesso, retenção e comunicação de risco. Aceitar caminho equivalente quando cálculos, premissas, evidência, limite e decisão forem coerentes. |
- **AED-C02-D13:** - **AED-C02-D13.** Divisor 4 para população e variância 2 (0,4); divisor 3 para estimação e 2,67 (0,4); média estimada reduz dispersão aparente (0,6); um desvio determinado pelos outros/grau de liberdade (0,6).
