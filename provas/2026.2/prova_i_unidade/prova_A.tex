...
\bigskip
% origem: AED-C03-O10
\ItemHeader{1}{Objetiva}{Calcular correlação de Pearson}{Tabela de somas centradas}

\ChamadaEditorial{Pares de estudo e nota | Associação não é causalidade}
\TextoBase

Em cinco pares de horas de estudo e nota, a tabela de desvios produziu
\[
\sum (x_i-\bar x)(y_i-\bar y)=16,\qquad
\sum(x_i-\bar x)^2=10,\qquad
\sum(y_i-\bar y)^2=36.
\]
Os pares foram preservados por estudante e o gráfico sugere tendência aproximadamente linear. A equipe quer padronizar a variação conjunta, sem convertê-la em causalidade.
...
\begin{enumerate}[label=\Alph*)]
  \item $16/\sqrt{10\times36}\approx0{,}843$, associação linear positiva forte.
  \item $16/(10+36)\approx0{,}348$, associação fraca.
  \item $16/5=3{,}2$, correlação acima de um.
  \item $\sqrt{16/360}\approx0{,}211$.
  \item $16/(4\times4)=1$, relação causal perfeita.
\end{enumerate}

% origem: AED-C03-O05
\ItemHeader{2}{Objetiva}{Testar independência}{Urgência e reabertura}
...
% origem: AED-C04-O03
\ItemHeader{4}{Objetiva}{Evitar distorção de eixo}{Variação mensal}
...
% origem: AED-C07-D13
\ItemHeader{5}{Discursiva}{Integrar evidências e justificar decisão}{Caso profissional do capítulo}
...
% origem: AED-C02-D13
\ItemHeader{7}{Discursiva}{Explicar o divisor amostral}{Amostra de equipamentos}
...
% origem: AED-C06-O09
\ItemHeader{8}{Objetiva}{storytelling}{Situação profissional e suporte quantitativo}
