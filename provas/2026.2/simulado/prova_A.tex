...
\bigskip
% origem: AED-C01-O07
\ItemHeader{1}{Objetiva}{Distinguir dado, informação, insight e decisão}{Incidente de estoque}
...
% origem: AED-C11-O07
\ItemHeader{2}{Objetiva}{Calcular capacidade e custo por resposta útil}{Teste de carga}
\TextoBase
...
% origem: AED-C12-D15
\ItemHeader{3}{Discursiva}{Especificar teste de atualização}{Troca do modelo local}
\TextoBase
...
% origem: AED-C07-O01
\ItemHeader{4}{Objetiva}{grão}{Situação profissional e suporte quantitativo}
...
% origem: AED-C05-O09
\ItemHeader{7}{Objetiva}{Aplicar minimização por consumo}{SPEC de gestão}
...
% origem: AED-C01-D11
\ItemHeader{8}{Discursiva}{Construir cadeia analítica verificável}{Caso de evasão}
