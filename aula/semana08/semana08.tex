...
\begin{SolvedBox}
\textbf{Questão para o Quadro — AED vs. Análise Explanatória}

Classifique cada frase como \textbf{AED} (exploratória) ou
\textbf{Explanatória} (storytelling com dados):
...
\begin{enumerate}[label=\alph*)]
  ...
  \item ``A correlação entre investimento e leads é $r = 0{,}87$.''
  \item ``Recomendo investir R\$ 200k no canal digital porque cada
  R\$ 1 investido gera R\$ 4,20 em leads qualificados.''
\end{enumerate}

\textbf{Resolução:}\\
(a) \textbf{AED} — descreve o que o dado mostra, sem ação.\\
(b) \textbf{Explanatória} — direciona decisão com dado + impacto.\\
(c) \textbf{AED} — reporta uma métrica, sem recomendação.\\
(d) \textbf{Explanatória} — Big Idea com ação específica + ROI.

\textbf{Regra:} AED pergunta ``o que os dados mostram?''.
Explanatória pergunta ``que decisão devemos tomar com base nisso?''.
\end{SolvedBox}
