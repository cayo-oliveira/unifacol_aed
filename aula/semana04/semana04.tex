...
\begin{enumerate}
  \item 19h–20h — \textbf{Apresentações:} Infográficos de Função (2 min por aluno)
  \item 20h–20h30 — \textbf{TEORIA:} Amplitude, Variância e Desvio Padrão
  \item 20h30–21h — \textbf{TEORIA:} IQR, Regra dos 1,5×IQR e Boxplot
  \item 21h–21h20 — \textbf{TEORIA:} Quando usar DP vs IQR + Comparação entre grupos
  \item 21h20–21h45 — \textbf{PRÁTICA EM DUPLA:} Tabelas 1 e 2 (10 linhas cada)
  \item 21h45–22h — \textbf{ATIVIDADE INDIVIDUAL FINAL} + lançamento do T2
\end{enumerate}
\end{BoardBox}
...
% =============================================================================
\section{Parte II — Teoria: Medidas de Dispersão (20h–21h20)}
% =============================================================================
