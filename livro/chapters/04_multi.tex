...
\begin{SolvedBox}[title=Questão de Fixação 1 - Correlação ≠ Causalidade]
\textbf{Questão:} Correlação entre "horas estudo" e "nota prova" é r = 0,85. Chefe diz: "Mais estudo causa notas maiores". Correto?

A) Incorreto, correlação não implica causalidade  
B) Correto, r alto prova causalidade  
C) Correto, correlação positiva  
D) Incorreto, r baixo  
E) Correto, estudo causa aprendizado

\textbf{Resposta:} \textbf{A}  
\textbf{Explicação:} Correlação mede associação, não causa-efeito.
\end{SolvedBox}

\begin{SolvedBox}[title=Questão de Fixação 2 - Scatter Plot e Correlação]
\textbf{Questão:} Scatter mostra pontos ascendendo esquerda-direita, r = 0,85. Interpretação?

A) Correlação positiva forte, mas não prova causalidade  
B) Prova causalidade  
...
\textbf{Resposta:} \textbf{A}  
\textbf{Explicação:} r = 0,85 indica associação forte, mas causalidade requer experimentos.
\end{SolvedBox}

\begin{SolvedBox}[title=Questão de Fixação 3 - Matriz de Correlação]
\textbf{Questão:} Matriz mostra X-Y: 0,92; Y-Z: 0,95. Conclusão "X causa Y que causa Z"?

A) Incorreta, correlação não implica causalidade; pode haver variável oculta  
B) Correta, ordem X→Y→Z é óbvia  
C) Correta, Y tem maior correlação  
D) Incorreta, correlações não são 1,0  
E) Correta, única possibilidade

\textbf{Resposta:} \textbf{A}  
\textbf{Explicação:} Alta correlação não prova cadeia causal; confounders possíveis.
\end{SolvedBox}
