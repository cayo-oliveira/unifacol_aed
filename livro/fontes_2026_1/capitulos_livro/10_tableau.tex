...
\textbf{1. Qual é a função dos filtros em dashboards do Tableau?}

\begin{enumerate}[a)]
  \item Alterar a cor dos gráficos automaticamente.
  \item Permitir que usuários interajam e limitem os dados exibidos.
  \item Calcular médias automaticamente.
  \item Criar novos campos calculados.
\end{enumerate}

\textbf{Resposta: b) Permitir que usuários interajam e limitem os dados exibidos.} \\
\textbf{Explicação:} Filtros permitem personalização da visualização, focando em subsets específicos de dados.

\textbf{2. Como se define um parâmetro no Tableau?}

\begin{enumerate}[a)]
  \item Uma medida calculada automaticamente.
  \item Um valor dinâmico que pode ser controlado pelo usuário para alterar cálculos ou visualizações.
  \item Um tipo de gráfico específico.
  \item Uma conexão com fonte de dados externa.
\end{enumerate}

\textbf{Resposta: b) Um valor dinâmico que pode ser controlado pelo usuário para alterar cálculos ou visualizações.} \\
\textbf{Explicação:} Parâmetros adicionam interatividade, permitindo mudanças em tempo real sem alterar a estrutura do dashboard.

\textbf{3. O que permitem as ações no Tableau?}

\begin{enumerate}[a)]
  \item Criar novos sheets automaticamente.
  \item Conectar visualizações para navegação e filtragem interativa.
  \item Exportar dados para Excel.
  \item Alterar fontes de dados.
\end{enumerate}

\textbf{Resposta: b) Conectar visualizações para navegação e filtragem interativa.} \\
\textbf{Explicação:} Ações criam dashboards dinâmicos, onde interações em uma visualização afetam outras.
\end{SolvedBox}
